...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        TestData4Dao.createTable(db, ifNotExists);
        TestData5Dao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        TestData4Dao.dropTable(db, ifExists);
        TestData5Dao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(TestData4Dao.class);
        registerDaoClass(TestData5Dao.class);
    }
