...
import com.classliu.greendao.db.DaoSession;
...
/**
 * DAO for table "TEST_DATA5".
*/
public class TestData5Dao extends AbstractDao<TestData5, Long> {

    public static final String TABLENAME = "TEST_DATA5";

    /**
     * Properties of entity TestData5.<br/>
    ...
    public TestData5Dao(DaoConfig config) {
        super(config);
    }
    
    public TestData5Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TEST_DATA5\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TEST_DATA5\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TestData5 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TestData5 entity) {
        stmt.clearBindings();
    ...
    @Override
    public TestData5 readEntity(Cursor cursor, int offset) {
        TestData5 entity = new TestData5( //
    ...
    @Override
    public void readEntity(Cursor cursor, TestData5 entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TestData5 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TestData5 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TestData5 entity) {
