...
public class TestDataDao extends AbstractDao<TestData, Long> {
    ...
    public static class Properties {
        ...
        public final static Property CreatId = new Property(6, Integer.class, "creatId", false, "CREAT_ID");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, TestData entity) {
        ...
        Integer creatId = entity.getCreatId();
        if (creatId != null) {
            stmt.bindLong(7, creatId);
        }
    }
    ...
    public TestData readEntity(Cursor cursor, int offset) {
        TestData entity = new TestData( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getInt(offset + 6) // creatId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TestData entity, int offset) {
        ...
        entity.setCreatId(cursor.isNull(offset + 6) ? null : cursor.getInt(offset + 6));
     }
